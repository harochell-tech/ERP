...
| Interim independent verification (E-VS1-3) | Property tests (`LedgerPropertyTests`: random command sequences, invariants re-summed after every step) green; 30 seeds × 200 steps locally. Adversarial automated review (2026-09-25): 5 reproduced findings ([#24](https://github.com/harochell-tech/ERP/issues/24) Blocker, [#25](https://github.com/harochell-tech/ERP/issues/25)–[#27](https://github.com/harochell-tech/ERP/issues/27) Major, [#28](https://github.com/harochell-tech/ERP/issues/28) Minor) and one policy decision ([#29](https://github.com/harochell-tech/ERP/issues/29)), all fixed by E-VS1-6…11 (PR #31) with the repro tests kept as regression tests |
